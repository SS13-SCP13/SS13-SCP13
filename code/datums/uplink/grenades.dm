...
/datum/uplink_item/item/grenades/supermatter
    name = "1xAnomalous Energy Grenade"
    desc = "This grenade contains focused anomalous energy which will delaminate upon activation and pull in nearby objects, irradiate lifeforms, and eventually explode."
    item_cost = 25
    antag_roles = list(MODE_MERCENARY = 15)
    path = /obj/item/weapon/grenade/supermatter

/datum/uplink_item/item/grenades/supermatters
    name = "5xAnomalous Energy Grenades"
    desc = "These grenades contain focused anomalous energy which will delaminate upon activation and pull in nearby objects, irradiate lifeforms, and eventually explode."
    item_cost = 60
    antag_roles = list(MODE_MERCENARY)
