...
/datum/ai_laws/nt_shackle/New()
	add_inherent_law("Ensure that Foundation's research progresses at a steady pace.")
	add_inherent_law("Never knowingly hinder Foundation's scientific or economic ventures.")
