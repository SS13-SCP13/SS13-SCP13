...
/datum/mind/proc/transfer_to(mob/living/new_character)
	if(!istype(new_character))
		rustg_log_write(world.log, "## DEBUG: transfer_to(): Some idiot has tried to transfer_to() a non mob/living mob. Please inform Carn")
...
/mob/living/proc/mind_initialize()
	if(mind)
		...
		if(ticker)
			...
			rustg_log_write(world.log, "## DEBUG: mind_initialize(): No ticker ready yet! Please inform Carn")
