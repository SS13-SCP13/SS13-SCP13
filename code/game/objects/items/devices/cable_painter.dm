obj/item/device/cable_painter
	...
	description_fluff = "A device often used by engineers to color-code their electrical systems. An experienced technician can identify traditional installations by color alone."
