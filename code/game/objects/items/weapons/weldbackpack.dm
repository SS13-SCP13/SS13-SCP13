/obj/item/weapon/weldpack
	...
	description_fluff = "The Shenzhen Chain of 2028 was an industrial accident of noteworthy infamy that occurred aboard an industrial transport ship. An apprentice welder, working for the Shenzhen Sea Fabrication Group, failed to properly seal her fuel port, triggering a chain reaction that spread from laborer to laborer, instantly vaporizing a crew of fourteen. Don't let this happen to you!"
