...
/obj/item/weapon/implant/imprinting/get_data()
	...
	<b>Name:</b> Foundation BB-56 "Educator" Employee Assistance Implant<BR>
	<b>Life:</b> 1 year.<BR>
	<HR>
	...
	It is HIGLY ILLEGAL and Foundation does NOT endorse use of this device in such way.
	Any amount of Foundation brand "Mind-Breaker"(TM) present in bloodstream will trigger this side-effect.<BR>"}
