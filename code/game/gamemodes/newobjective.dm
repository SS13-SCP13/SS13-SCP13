	...
	objective
		...
		steal
			...
			*/
			...
			/*burger
				...
				explanation_text = "Steal a burger made out of human organs, this will be presented as proof of Foundation's chronic lack of standards."
				weight = 60
			...
			/*magboots
				...
				explanation_text = "Steal a pair of \"Foundation\" brand magboots."
				weight = 20
		...
		block
			...
			check_completion()
				...
				for(var/living in GLOB.living_mob_list_)
					var/mob/living/player = living
			...
			proc/gen_amount_goal(var/lowbound = 4, var/highbound = 6)
				...
				if (ticker)
					...
					if (ticker.current_state == GAME_STATE_SETTING_UP)
						for(var/mob/new_player/P in GLOB.mob_list)
							if(P.client && P.ready && P.mind!=owner)
								n_p ++
					else if (ticker.current_state == GAME_STATE_PLAYING)
						for(var/human in GLOB.human_mob_list)
							var/mob/living/carbon/human/P = human
