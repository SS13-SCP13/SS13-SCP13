/client/proc/atmosscan()
	...
	for (var/obj/machinery/atmospherics/plumbing in SSmachines.all_machinery)
		if (plumbing.nodealert)
			to_chat(usr, "Unconnected [plumbing.name] located at [plumbing.x],[plumbing.y],[plumbing.z] ([get_area(plumbing.loc)])")

	//Manifolds
	for (var/obj/machinery/atmospherics/pipe/manifold/pipe in SSmachines.all_machinery)
