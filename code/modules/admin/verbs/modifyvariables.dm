...
/client/proc/mod_list_add(var/list/L, atom/O, original_name, objectvar)
	...
	rustg_log_write(world.log, "### ListVarEdit by [src]: [O.type] [objectvar]: ADDED=[var_value]")
...
/client/proc/mod_list(var/list/L, atom/O, original_name, objectvar)
	...
	switch(class) //Spits a runtime error if you try to modify an entry in the contents list. Dunno how to fix it, yet.
		...
		if("DELETE FROM LIST")
			rustg_log_write(world.log, "### ListVarEdit by [src]: [O.type] [objectvar]: REMOVED=[html_encode("[variable]")]")
	...
	rustg_log_write(world.log, "### ListVarEdit by [src]: [O.type] [objectvar]: [original_var]=[new_var]")
...
/client/proc/modify_variables(var/atom/O, var/param_var_name = null, var/autodetect_class = 0)
	...
	rustg_log_write(world.log, "### VarEdit by [src]: [O.type] [variable]=[html_encode("[new_value]")]")
