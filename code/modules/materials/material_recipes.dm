...
/material/steel/generate_recipes()
	...
	recipes += new/datum/stack_recipe("mono tile", /obj/item/stack/tile/mono, 1, 4, 20)
	recipes += new/datum/stack_recipe("mono floor tile", /obj/item/stack/tile/monofloor, 1, 4, 20)
	recipes += new/datum/stack_recipe("dark mono floor tile", /obj/item/stack/tile/mono/dark, 1, 4, 20)
	recipes += new/datum/stack_recipe("white mono floor tile", /obj/item/stack/tile/mono/white, 1, 4, 20)
