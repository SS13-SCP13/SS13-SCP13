...
/datum/admins/proc/setup_supermatter()
	...
	for(var/obj/effect/engine_setup/coolant_canister/C in global.effect_list)
		switch(response)
			if("N2")
	...
	for(var/obj/effect/engine_setup/core/C in global.effect_list)
		switch(response)
			if("N2")
	...
	for(var/obj/effect/engine_setup/filter/F in global.effect_list)
		F.coolant = response
