...
/obj/item/clothing/suit/space/void/medical
	...
	desc = "A sterile voidsuit with minor radiation shielding and a suite of self-cleaning technology. Standard issue in Foundation medical facilities."
	item_state_slots = list(
...
/obj/item/clothing/suit/space/void/atmos/alt
	desc = "An expensive Foundation voidsuit, rated to withstand extreme heat and even minor radiation without exceeding room temperature within."
