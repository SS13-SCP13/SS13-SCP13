...
#define ASSIGNMENT_VIROLOGY "Virologist"
...
/datum/event_container/mundane
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Cold Outbreak",/datum/event/space_cold,		50,	list(ASSIGNMENT_VIROLOGY = 20)),
	)
...
/datum/event_container/moderate
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Rehabilitation Center Alert",				/datum/event/prison_break,				0,		list(ASSIGNMENT_SECURITY = 100)),
...
/datum/event_container/major
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Rehabilitation Center Alert",	/datum/event/prison_break,0,list(ASSIGNMENT_ANY = 5)),
		new /datum/event_meta/no_overmap(EVENT_LEVEL_MAJOR, "Meteor Wave",			/datum/event/meteor_wave,		0,	list(ASSIGNMENT_ENGINEER = 10),	1),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Vines",			/datum/event/spacevine, 		0,	list(ASSIGNMENT_ENGINEER = 15), 1),
