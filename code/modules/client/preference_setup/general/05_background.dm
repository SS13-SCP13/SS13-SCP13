/datum/preferences
	...
	var/sec_record = ""
	var/gen_record = ""
	var/foundation_relation = "Neutral"
	var/memory = ""
...
/datum/category_item/player_setup_item/general/background/load_character(var/savefile/S)
	...
	from_file(S["foundation_relation"],pref.foundation_relation)
...
/datum/category_item/player_setup_item/general/background/save_character(var/savefile/S)
	...
	to_file(S["foundation_relation"],pref.foundation_relation)
...
/datum/category_item/player_setup_item/general/background/sanitize_character()
	...
	pref.foundation_relation = sanitize_inlist(pref.foundation_relation, COMPANY_ALIGNMENTS, initial(pref.foundation_relation))

/datum/category_item/player_setup_item/general/background/content(var/mob/user)
	. += "<b>Background Information</b><br>"
	. += "[GLOB.using_map.company_name] Relation: <a href='?src=\ref[src];nt_relation=1'>[pref.foundation_relation]</a><br/>"
...
/datum/category_item/player_setup_item/general/background/OnTopic(var/href,var/list/href_list, var/mob/user)
	if(href_list["nt_relation"])
		var/new_relation = input(user, "Choose your relation to [GLOB.using_map.company_name]. Note that this represents what others can find out about your character by researching your background, not what your character actually thinks.", CHARACTER_PREFERENCE_INPUT_TITLE, pref.foundation_relation)  as null|anything in COMPANY_ALIGNMENTS
		if(new_relation && CanUseTopic(user))
			pref.foundation_relation = new_relation
