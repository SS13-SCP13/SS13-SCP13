...
/obj/structure/closet/secure_closet/scp/admin/facilityadmin
	name = "facility director's locker"
	req_access = list(access_sitedirect)
	icon_state = "flocked"
...
/obj/structure/closet/secure_closet/scp/admin/facilityadmin/WillContain()
	return list(
