...
/decl/security_level/default/torchdept/code_green
	...
	var/static/datum/announcement/priority/security/security_announcement_green = new(do_log = 0, do_newscast = 1, new_sound = sound('sound/AI/ds90/codegreen.ogg', volume = 80))
